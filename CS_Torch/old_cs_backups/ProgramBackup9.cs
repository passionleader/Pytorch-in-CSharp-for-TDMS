//// dynamic type list 할당으로 데이터타입에 상관 없이 2차원 배열 보내기 가능해 짐 -> python에 DF 만드는 것 까지 성공, 200ms 소요
//using System;
...
//        {
//            // TDMS 파일 읽기
//            using (var tdms = new NationalInstruments.Tdms.File("./TDMS/sample.tdms"))
//            {
//                tdms.Open();
...
//                        // 클래스 선언, 전달 인자 - 칼럼명(ch_name), 데이터(2d layer), 데이터 사이즈(col*row)
